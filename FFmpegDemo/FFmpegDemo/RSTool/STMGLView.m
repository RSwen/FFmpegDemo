...
@interface STMMovieGLRenderer_RGB : NSObject<STMMovieGLRenderer> {
...
@implementation STMMovieGLRenderer_RGB
...
@interface STMMovieGLRenderer_YUV : NSObject<STMMovieGLRenderer> {
...
@implementation STMMovieGLRenderer_YUV
...
@implementation STMGLView {
    ...
    id<STMMovieGLRenderer> _renderer;
}
...
- (id) initWithFrame:(CGRect)frame videoFrameSize:(CGSize)videoFrameSize videoFrameFormat:(STMVideoFrameFormat)videoFrameFormat
{
    ...
    if (self) {
        ...
        if (videoFrameFormat == STMVideoFrameFormatYUV) {
            ...
            _renderer = [[STMMovieGLRenderer_YUV alloc] init];
            NSLog(@"OK use YUV GL renderer");
            
        } else {
            
            _renderer = [[STMMovieGLRenderer_RGB alloc] init];
